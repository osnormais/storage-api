...
public class DraftFileController {
    ...
    @GetMapping
    public ResponseEntity<StreamingResponseBody> getChunkInputStream(DownloadFileChunkInput input) {
    ...
    public ResponseEntity<CreateFileDownloadTransferChannelOutput> createFileUploadTransferChannel(
